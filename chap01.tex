...
a single trace. % todo collecting semantics
The set of all possible traces cannot be computed by the statement semantics, but something called \textbf{Collecting
semantics}. \xxx{TODO}
