...
Consequently, the items can be accessed using the values in the index. \xxx{TODO a schematic picture of the series}
...
\xxx{TODO a schematic picture of the dataframe}
...
Data frame is a two-dimensional \xxx{TODO}