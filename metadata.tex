...
\def\Abstract{%
\xxx{TODO rewrite the abstract}
Abstract interpretation is an approximation method for analyzing semantics of computer programs.
It systematically interprets the program semantics over an abstract domain which is
connected with the original (concrete) domain by a galois connection.
...
usually error-prone, since the dynamic languages lack any checks before the actual run
of the program.
The goal of this paper is to explore the possibility to use abstract interpretation
to analyze data-analysis programs working with tabular data and to implement a proof-of-concept
